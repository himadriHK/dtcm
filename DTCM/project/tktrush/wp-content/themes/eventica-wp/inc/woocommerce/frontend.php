...
if( of_get_option( 'tokopress_minicart_header' ) ) {
	add_filter('add_to_cart_fragments', 'tokopress_wc_header_add_to_cart_fragment');
}
...
function tokopress_wc_header_menu_item_minicart ( $items, $args ) {
    if ( $args->theme_location == 'header_menu' ) {
        $items .= '<li class="menu-item"><a href="'.WC()->cart->get_cart_url().'"><i class="fa fa-shopping-cart"></i><span class="minicart">'.WC()->cart->get_cart_subtotal().'</span></a></li>';
    }
    return $items;
}